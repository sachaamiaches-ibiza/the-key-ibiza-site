          ...
          <div className="space-y-16 animate-slide-up">
            ...
            <div className="pt-10">
              <button 
                ...
                className="bg-white text-luxury-blue px-12 py-6 rounded-full font-bold text-lg hover:bg-luxury-gold hover:text-white transition-all shadow-2xl uppercase tracking-widest text-[11px]"
              >
                Inquire Now
              </button>
            </div>
