...
const WishlistBadge: React.FC<WishlistBadgeProps> = ({ count, hasDates, onClick }) => {
  ...
  return (
    <button
      onClick={onClick}
      className={`fixed top-32 right-6 z-[90] flex items-center gap-3 px-5 py-3 rounded-full font-semibold shadow-xl hover:scale-105 transition-transform animate-fadeIn ${
        hasDates
