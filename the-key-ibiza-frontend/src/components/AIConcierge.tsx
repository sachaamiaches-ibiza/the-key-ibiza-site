        ...
        <div className="bg-luxury-blue/98 border border-white/10 w-85 md:w-96 lg:w-[420px] rounded-[40px] overflow-hidden shadow-2xl backdrop-blur-3xl animate-slide-up ring-1 ring-white/5">
          ...
          <div className="p-6 bg-white/5 border-t border-white/5 flex space-x-4">
            ...
            <button
              onClick={handleSend}
              disabled={showOptions || isComplete}
              className="bg-luxury-gold text-luxury-blue w-12 h-12 rounded-2xl flex items-center justify-center border border-luxury-gold hover:bg-luxury-blue hover:text-luxury-gold hover:scale-105 transition-all shadow-xl active:scale-95 disabled:opacity-50 disabled:hover:scale-100"
            >
