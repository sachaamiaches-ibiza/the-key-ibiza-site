    ...
    >
      ...
      {(checkIn || checkOut) && (
        <button
          ...
          className="w-full mb-4 py-2 text-[10px] uppercase tracking-widest text-white/40 hover:text-white/70 transition-colors flex items-center justify-center gap-2"
        >
  ...
  return (
    <>
      ...
      <div className="container mx-auto px-6 lg:px-16 xl:px-24 pb-8 md:pb-16">
        ...
        <div className="py-10 md:py-12">
          <h3 className="text-lg md:text-xl font-serif text-white tracking-wide text-center mb-6 md:mb-8 flex items-center justify-center gap-3">
            {villa.icalUrl ? (
              <>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 md:gap-6 mt-4 md:mt-6 text-[10px] md:text-xs text-white/60">
