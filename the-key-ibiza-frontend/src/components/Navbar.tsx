...
const Navbar: React.FC<NavbarProps> = ({ currentView, onNavigate, lang, onLanguageChange, onGoBack, canGoBack, onOpenContact }) => {
  ...
  const menuImages = {
    ...
    'service-driver': 'https://images.unsplash.com/photo-1618843479313-40f8afb4b4d8?auto=format&fit=crop&q=80&w=1200',
        ...
        <div className={`relative z-10 h-full w-full flex flex-col justify-start items-center md:items-start px-8 md:pl-24 pt-10 transition-transform duration-700 ${isMenuOpen ? 'translate-y-0' : 'translate-y-10'}`}>
          ...
          <div className="mt-auto pb-10 flex flex-col md:flex-row items-center md:items-end md:justify-between w-full max-w-4xl border-t border-white/5 pt-10">
            <div className="text-center md:text-left mb-8 md:mb-0">
              ...
              <a href="https://wa.me/34660153207" target="_blank" rel="noopener noreferrer" className="text-lg text-white/30 hover:text-white transition-colors tracking-widest font-light flex items-center gap-2">
